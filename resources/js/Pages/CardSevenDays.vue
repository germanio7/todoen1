<template>
    <div>
        <div class="flex-1  justify-center p-2">
            <div
                class="w-full border-b-4 border-purple-500 bg-white rounded flex-wrap items-center p-6 bg-white"
            >
                    ...
                    <div class="flex w-full justify-between items-center">
                        ...
                        >
                            <div class="flex justify-end items-center">
                                ...
                                {{ Math.round(item.highTemperature) }}ºC
                            </div>
                            <div class="flex justify-end items-center">
                                <svg
                                    aria-hidden="true"
                                ...
                                {{ Math.round(item.lowTemperature) }}ºC
                            </div>
                        </div>
                    </div>
                    <hr />
