            ...
            <div class="grid gap-6 grid-cols-1 md:grid-cols-2 lg:grid-cols-3 ">
                <div v-for="item in news" :key="item.id">
                    ...
                    >
                        ...
                        <div
                            class="grid grid-cols-1 justify-between items-center"
                        >
