                ...
                <section class="text-gray-700 body-font">
                    <div class="container px-8 mx-auto py-36 lg:px-4">
                        ...
                        >
                            ...
                            <h1
                                class="mb-6 text-2xl font-semibold tracking-tighter text-blue-800 sm:text-6xl title-font"
                            >
                                Todo en 1
                            </h1>
                        </div>
                ...
                <div class="container px-8 mx-auto py-36 lg:px-4">
                    <div class="flex flex-wrap text-left">
                        <div class="px-8 py-6 lg:w-1/4 md:w-full">
                            ...
                            <h2
                                class="mb-3 text-center text-lg font-semibold text-gray-700 lg:text-2xl title-font"
                            >
                                Noticias
                            </h2>
                        </div>
